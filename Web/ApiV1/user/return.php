...
$insert_sql = "INSERT INTO request (rent_id, id_user, id_item, total_request, type, request_date, status, return_date) VALUES ('$id_rent', '$borrower_id', '$id_item', '$total', 'returning', NOW(), 'pending', '$return')";
